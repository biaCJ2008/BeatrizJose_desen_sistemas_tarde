        ...
        <div class="card">
          <div class="card-header">
            <h4>Lista de Clientes
              <a href="cadastrar_cliente.php" class="btn btn-primary float-end">Adicionar Cliente</a>
            </h4>
          </div>
          <div class="card-body">
            <!-- Barra de Pesquisa -->
                  ...
                  foreach ($clientes as $cliente) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="alterar_cliente1.php?id=<?= $id_cliente ?>" class="btn btn-success btn-sm">
